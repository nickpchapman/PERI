...
//                 <div className="title is-6">{trip.tripName + 'HELLLLLLO'}</div>
//                 <div className="subtitle is-6">{trip.destination}</div>
//                 <div className="is-size-7">{trip.spots.length + ' locations on this trip'}</div>
//                 <div className="is-size-7">{'Created by: ' + trip.username}</div>
//                 <div className="is-size-7">{this.parseHashtag.call(this, trip.hashtag)}</div>
//               </div>
//             </div>
//             <div className="is-size-7">{'Created by: ' + trip.username}</div>
//           </div>
